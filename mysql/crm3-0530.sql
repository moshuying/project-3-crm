...
INSERT INTO `customer_enterprise` VALUES ('31', '案发时地方撒', null, '3333', null, null, null, '3333333333', '', null, '1', 'admin', null, null, null);
...
CREATE TABLE `dictionary_table_biz_ref` (
  ...
  `dic_id` int(11) NOT NULL COMMENT '字典的id',
  `biz_name` int(11) NOT NULL COMMENT '业务设置表：1、企业表，2、联系人表，3、员工表、4跟进表、5、业务表、6其他',
  `table_name` varchar(50) DEFAULT NULL COMMENT '数据库表名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='字典跟各个业务表的绑定表';
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('1', 'admin', '$2a$10$OG1zaFHT2LUy4SGcQ4EnRu9sPQMjMGEE6jARz61aQwRQ3316N6ikG', '1623@163.com', '20', '2', '2021-05-14 00:28:00', '1', '1', '2023-05-30 16:51:28', '2021-05-21 08:46:19');
