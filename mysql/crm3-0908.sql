...
Source Database       : crm3

Target Server Type    : MYSQL
Target Server Version : 100803
File Encoding         : 65001

Date: 2023-09-08 18:55:37
*/
...
CREATE TABLE `baobei` (
  ...
  `project_desc` varchar(255) DEFAULT NULL COMMENT '描述信息',
  `user_id` int(11) DEFAULT NULL,
  `user_name` varchar(255) DEFAULT NULL,
  `create_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='作废，测试用的表';
...
CREATE TABLE `bizs` (
  ...
  `contact_id` int(11) DEFAULT NULL COMMENT '联系人id,微信第二次进来通过openid获取',
  `contact_name` varchar(255) DEFAULT NULL COMMENT '联系人名字',
  `contact_ent_id` int(11) DEFAULT NULL COMMENT '联系人所属企业id，关联后才有',
  `contact_tel` varchar(255) DEFAULT NULL COMMENT '报备人手机号码',
  `customer_ent_id` int(11) DEFAULT NULL COMMENT '如果报备客户存在显示',
  `biz_ent_name` varchar(255) NOT NULL COMMENT '最终报备客户名称',
  `biz_desc` varchar(255) DEFAULT NULL COMMENT '客户商机描述, 根据这个配备资源',
  `biz_stage` varchar(255) DEFAULT NULL COMMENT '商机阶段，消息提醒判断',
  `product_id` int(11) DEFAULT NULL COMMENT '报备产品',
  `product_name` varchar(255) DEFAULT NULL COMMENT '冗余产品名称（冗余）',
  `product_desc` varchar(255) DEFAULT NULL COMMENT '产品详情描述',
  `employee_id` int(11) DEFAULT NULL COMMENT '对口业务经理',
  `employee_name` varchar(255) DEFAULT NULL COMMENT '业务经理姓名（冗余，用于查询）',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='商机管理表，管理商机报备，内外报备，提醒跟进等';
...
CREATE TABLE `customer_contacts` (
  ...
  `gender` int(11) NOT NULL COMMENT '客户性别 页面为下拉框 1男 0女',
  `tel` varchar(255) NOT NULL COMMENT '电话号码',
  `qq` varchar(255) DEFAULT NULL,
  `job` int(11) NOT NULL,
  `source` int(11) NOT NULL COMMENT '客户来源',
  `seller` int(11) DEFAULT NULL COMMENT '负责人 填写为当前登录用户',
  `inputUser` int(11) NOT NULL COMMENT ' 创建人 填写为当前登录用户',
  `inputTime` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `status` int(11) NOT NULL DEFAULT 0 COMMENT '-2:流失 -1:开发失败 0:潜在客户 1:正式客户 2:资源池客户',
  `positiveTime` datetime DEFAULT NULL COMMENT '转正时间',
  `customer_ent_id` int(11) DEFAULT NULL COMMENT '客户企业id',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `customer_manager_id_uindex` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of customer_contacts
-- ----------------------------
INSERT INTO `customer_contacts` VALUES ('1', '秦农', '29', '1', '13766546213', '100001', '3', '17', '1', '1', '2023-09-01 10:50:13', '0', '2021-05-20 19:31:02', '20');
INSERT INTO `customer_contacts` VALUES ('2', '马腾', '33', '1', '188888888', '100002', '3', '17', '2', '2', '2023-09-01 10:50:15', '2', '2021-05-20 19:31:02', '21');
INSERT INTO `customer_contacts` VALUES ('3', '张云', '21', '1', '18888888888', '100001', '3', '17', '3', '3', '2023-09-01 10:50:17', '1', '2021-05-20 19:31:02', '22');
INSERT INTO `customer_contacts` VALUES ('4', '权志龙', '18', '1', '18888888888', '100001', '3', '17', '5', '5', '2023-09-01 10:50:18', '2', '2021-05-20 19:31:02', '23');
INSERT INTO `customer_contacts` VALUES ('5', '马钊', '23', '1', '16666666666', '100001', '3', '17', '4', '4', '2023-09-01 10:50:20', '1', '2021-05-20 19:31:02', '24');
INSERT INTO `customer_contacts` VALUES ('6', '合理吗?🎃', '18', '0', '18888888888', '100001', '3', '17', '6', '6', '2023-09-01 10:50:22', '-2', '2021-05-20 19:31:02', '25');
INSERT INTO `customer_contacts` VALUES ('7', '酒剑仙🗡', '38', '1', '17777777777', '100001', '3', '17', '5', '5', '2023-09-01 10:50:24', '0', '2021-05-20 19:31:02', '26');
INSERT INTO `customer_contacts` VALUES ('8', '赵', '21', '1', '18888888888', '100001', '3', '17', '7', '7', '2023-09-01 10:50:27', '1', '2021-05-20 19:31:02', '27');
INSERT INTO `customer_contacts` VALUES ('9', '伊泽', '45', '0', '1999999999', '100001', '3', '17', '8', '8', '2023-09-01 10:50:29', '2', '2021-05-20 19:31:02', '28');
INSERT INTO `customer_contacts` VALUES ('10', '阿斯顿', '18', '1', '18888888888', '100001', '3', '17', '9', '9', '2023-09-01 10:50:33', '-1', '2021-05-20 19:31:02', '29');
INSERT INTO `customer_contacts` VALUES ('11', '廖嘉积', '54', '0', '18888888888', '100001', '3', '17', '3', '3', '2021-05-22 08:26:27', '-2', '2021-05-20 19:31:02', null);
INSERT INTO `customer_contacts` VALUES ('12', '郭晋安', '18', '1', '18888888888', '100001', '3', '17', '2', '2', '2021-05-22 08:26:27', '2', '2021-05-20 19:31:02', null);
INSERT INTO `customer_contacts` VALUES ('13', '埃里克森', '18', '1', '13333333333', '100002', '3', '17', '2', '2', '2021-05-22 08:26:27', '2', '2021-05-20 19:31:02', null);
INSERT INTO `customer_contacts` VALUES ('14', '张🗡男', '22', '1', '123123123', '123123', '28', '18', '2', '5', '2021-05-23 10:41:48', '0', null, null);
INSERT INTO `customer_contacts` VALUES ('15', '张华梁', '12', '1', '23444', '2123', '28', '20', '1', '1031', '2021-05-23 10:43:50', '1', null, null);
INSERT INTO `customer_contacts` VALUES ('16', '林阳露', '22', '0', '1234567', '12345678', '5', '21', '2', '1032', '2021-05-23 10:41:48', '0', null, null);
INSERT INTO `customer_contacts` VALUES ('17', '贵', '21', '1', '23444', '6532', '27', '18', '1', '1031', '2021-05-23 10:41:48', '0', null, null);
INSERT INTO `customer_contacts` VALUES ('18', '胡12', '123', '1', '123', '123', '28', '20', '1', '1', '2021-05-23 10:42:53', '0', null, null);
INSERT INTO `customer_contacts` VALUES ('19', '肖敏', '45', '1', '18688939187', '1231231231', '55', '222', '1', '1', '2023-09-01 14:59:18', '0', null, null);
INSERT INTO `customer_contacts` VALUES ('20', '123', '1', '1', '18688939187', '1231231231', '48', '2', '1', '1', '2023-09-01 15:22:43', '0', null, '28');
INSERT INTO `customer_contacts` VALUES ('21', '肖敏', '56', '1', '18688939187', '1231231231', '54', '11', '1', '1', '2023-09-08 10:41:14', '0', null, '9');
...
CREATE TABLE `customer_enterprise` (
  ...
  `ent_sn` varchar(30) DEFAULT NULL COMMENT '企业统一信用代码',
  `ent_boss` varchar(100) DEFAULT '' COMMENT '企业法人',
  `ent_addr` varchar(255) DEFAULT NULL COMMENT '企业地址',
  `ent_tel` varchar(20) DEFAULT NULL COMMENT '企业电话',
  `ent_email` varchar(60) DEFAULT NULL COMMENT '企业邮箱',
  `ent_website` varchar(255) DEFAULT '' COMMENT '企业官网',
  `ent_desc` varchar(255) DEFAULT '' COMMENT '企业简单描述，来自爱企查',
  `ent_cooperation_type` int(11) DEFAULT NULL COMMENT '企业与厂家合同类型：1、直接客户、2、渠道代理、3、供应商、4、战略合作、5、其他合作形式',
  `ent_belong_bizer_id` int(11) DEFAULT NULL COMMENT '该企业属于哪个销售人员负责',
  `ent_belong_bizer_name` varchar(50) DEFAULT NULL COMMENT '营销人员姓名',
  `create_time` datetime DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  `update_user` varchar(255) DEFAULT NULL COMMENT '更新人名字',
  PRIMARY KEY (`ent_id`) USING BTREE,
  UNIQUE KEY `unique` (`ent_name`) USING BTREE COMMENT '企业名称要唯一',
  KEY `epid` (`ent_belong_bizer_id`),
  CONSTRAINT `epid` FOREIGN KEY (`ent_belong_bizer_id`) REFERENCES `employee` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of customer_enterprise
-- ----------------------------
INSERT INTO `customer_enterprise` VALUES ('1', '123', null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `customer_enterprise` VALUES ('2', '123123123', null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `customer_enterprise` VALUES ('3', '1221111', null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `customer_enterprise` VALUES ('4', '1444', null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `customer_enterprise` VALUES ('5', '144433', null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `customer_enterprise` VALUES ('6', '河南网络公司', null, null, null, null, null, null, null, null, null, null, null, null, null);
INSERT INTO `customer_enterprise` VALUES ('7', '河南网络公司22', null, null, null, null, null, null, null, null, null, null, '2023-05-11 08:59:19', null, null);
INSERT INTO `customer_enterprise` VALUES ('9', '发生大幅', null, null, '阿斯蒂芬', null, null, '阿斯蒂芬', null, null, null, null, '2023-05-11 16:23:59', null, null);
INSERT INTO `customer_enterprise` VALUES ('10', 'sdsa ', null, null, 'asd ', null, null, 'asd   asd', null, null, null, null, '2023-05-11 16:31:51', null, null);
INSERT INTO `customer_enterprise` VALUES ('11', '分东风额', null, null, '3123123', null, null, '312312', null, null, '1', 'admin', '2023-05-11 17:39:49', null, null);
INSERT INTO `customer_enterprise` VALUES ('12', '12312', null, null, '123', null, null, '12312312', null, null, '1', 'admin', '2023-05-11 19:08:28', null, null);
INSERT INTO `customer_enterprise` VALUES ('13', '深圳一粒云', null, null, '深圳宝安区', null, null, 'www.yliyun.com', null, null, '1', 'admin', '2023-05-17 14:30:46', null, null);
INSERT INTO `customer_enterprise` VALUES ('14', '河南网络公司11', null, null, '111', null, null, '11', null, null, '1', 'admin', '2023-05-22 17:21:32', null, null);
INSERT INTO `customer_enterprise` VALUES ('15', '111', null, null, '111', null, null, '11', null, null, '1', 'admin', '2023-05-22 17:23:12', null, null);
INSERT INTO `customer_enterprise` VALUES ('16', '1', null, null, 'weeeeeee', null, null, '2', null, null, '1', 'admin', '2023-05-22 17:24:39', null, null);
INSERT INTO `customer_enterprise` VALUES ('17', '盛天商业', null, null, '深圳牛栏前大厦', null, null, 'shetnain.com', null, null, '1', 'admin', '2023-05-26 14:44:55', null, null);
INSERT INTO `customer_enterprise` VALUES ('18', '盛天上而言2', null, null, '2123', null, null, '123', null, null, '1', 'admin', '2023-05-26 15:01:19', null, null);
INSERT INTO `customer_enterprise` VALUES ('19', '河南网络公司222', null, null, '123', null, null, '12', null, null, '1', 'admin', '2023-05-26 15:02:27', null, null);
INSERT INTO `customer_enterprise` VALUES ('20', '河南网络公司666666666', null, null, '6666', null, null, '6666', null, null, '1', 'admin', '2023-05-26 15:03:15', null, null);
INSERT INTO `customer_enterprise` VALUES ('21', '河南网络公司8888888888', null, null, '8888', null, null, '888', null, null, '1', 'admin', '2023-05-26 15:10:29', null, null);
INSERT INTO `customer_enterprise` VALUES ('22', '河南网络公司9999999999', null, null, '99999', null, null, '999', null, null, '1', 'admin', '2023-05-26 15:23:28', null, null);
INSERT INTO `customer_enterprise` VALUES ('23', '河南网络公司1010', null, null, '1212', null, null, '121212', null, null, '1', 'admin', '2023-05-26 15:30:13', null, null);
INSERT INTO `customer_enterprise` VALUES ('24', '河南网络公司11111', null, null, '11111', null, null, '1111', null, null, '1', 'admin', '2023-05-26 15:30:25', null, null);
INSERT INTO `customer_enterprise` VALUES ('25', '易泰通(深圳)信息技术有限公司', '91440300MA5EWAPH9M', ' 雷大力', '深圳市南山区南头街道红花园社区深南大道12069号海岸时代公寓东座1505', '13076560190', '13076560190@163.com', ' www.hanweizhe.net', '简介：易泰通(深圳)信息技术有限公司成立于2017年12月04日，注册地位于深圳市南山区南头街道红花园社区深南大道12069号海岸时代公寓东座1505，法定代表人为雷大力。经营范围包括一般经营项目是：计算机硬件的开发、销售；计算机系统集成的开发、销售；软件开发、技术服务、技术咨询；通讯设备及配件的研发、销售；从事广告业务；国内贸易（不含专营、专卖、专控商品）；经营进出口业务。（以上项目法律、行政法规、国务院决定禁止的除外，限制的项目须取得许可后方可经营），许可经营项目是：', null, '1', 'admin', null, null, null);
INSERT INTO `customer_enterprise` VALUES ('26', '深圳市怡亚通供应链股份有限公司', '91440300279398406U', ' 周国辉', '深圳市宝安区新安街道海旺社区N26区海秀路2021号荣超滨海大厦A座2111', '88393198', '002183@eascs.com', 'www.eascs.com', '深圳市怡亚通供应链股份有限公司创立于1997年，是以物流为基础，以扁平化、共享化、去中心化的1+n供应链平台为载体（全面覆盖、全域营销、全程服务），以品牌运营、产业运营为核心，帮助客户实现市场份额保量、增量，从而提升客户核心竞争力的整合型运营服务商，成立于1997年，是世界500强——深圳市投资控股有限公司旗下企业，中国首家上市供应链公司（股票代码002183），在职员工近万人，2021年业务量超1000亿元，2022《财富》中国500强排名193位。', null, '1', 'admin', null, null, null);
INSERT INTO `customer_enterprise` VALUES ('27', '12312312312', '123123', '3123123', '12312', '12123', '123123', '312312', '3123', null, '1', 'admin', null, null, null);
INSERT INTO `customer_enterprise` VALUES ('28', '000000000000', '0000000', '00000', '000000000', '000000000', '000000000', '000000000', '00000000', null, '1', 'admin', null, null, null);
INSERT INTO `customer_enterprise` VALUES ('29', '看看看看', null, '靠靠靠靠靠靠靠', null, '看看', null, '看看', '看看', null, '1', 'admin', null, null, null);
INSERT INTO `customer_enterprise` VALUES ('30', '哈哈哈', null, '哈哈', null, null, null, '哈哈', '', null, '1', 'admin', null, null, null);
INSERT INTO `customer_enterprise` VALUES ('31', '5656566633时地方撒', '3333', '7733', '33333333', '33333', '3333', '3333333333', '333333', '0', '1', 'admin', null, null, null);
...
CREATE TABLE `customer_follow_up_history` (
  ...
  `traceDetails` text DEFAULT NULL COMMENT '跟进内容 计划的详细内容',
  `traceType` int(11) DEFAULT NULL COMMENT '跟进方式 计划采用如电话、邀约上门等  数据字典',
  `traceResult` int(11) DEFAULT NULL COMMENT '跟进效果 优----3、中----2、差----1',
  `customerID` int(11) DEFAULT NULL COMMENT '跟进客户 编辑时不可编辑 潜在客户对象/客户对象',
  `inputUser` int(11) DEFAULT NULL COMMENT '创建人 自动填入当前登录用户，用户不可更改 员工对象',
  `type` int(11) DEFAULT NULL COMMENT '跟进类型 0:潜在开发计划 1:客户跟进历史',
  `comment` text DEFAULT NULL,
  `trace_biz_mode` int(11) DEFAULT NULL COMMENT '''跟进业务模块:(业务、技术、财务、商务、其他)''',
  `customer_ent_id` int(11) DEFAULT NULL COMMENT '''跟进属于哪个企业',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `customer_follow_up_history_id_uindex` (`id`) USING BTREE
...
INSERT INTO `customer_follow_up_history` VALUES ('18', '2023-09-08 05:42:17', '随便聊了聊', '26', '1', '1', '1', '0', '钉钉', null, null);
INSERT INTO `customer_follow_up_history` VALUES ('19', '2023-09-08 05:47:25', '随便聊了聊', '26', '1', '1', '1', '0', '去去去', null, null);
INSERT INTO `customer_follow_up_history` VALUES ('20', '2023-09-08 07:08:10', '张云你好', '25', null, '3', '1', null, '我就是打电话随便问问', null, '22');
...
CREATE TABLE `customer_handover` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `customerID` int(11) DEFAULT NULL COMMENT '客户 客户对象',
  `transUser` int(11) DEFAULT NULL COMMENT '移交人员 实行移交操作的管理人员',
  `transTime` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `oldSeller` int(11) DEFAULT NULL COMMENT '老市场专员 客户上的原始市场人员',
  `newSeller` int(11) DEFAULT NULL COMMENT '新市场专员 由公司重新指派后的新市场人员',
  `transReason` varchar(255) DEFAULT NULL COMMENT '移交原因',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `customer_handover_id_uindex` (`id`) USING BTREE
...
CREATE TABLE `department` (
  ...
  `parent_id` int(10) unsigned zerofill DEFAULT NULL COMMENT '父部门id，默认顶级部门为0',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `department_id_uindex` (`id`) USING BTREE
...
CREATE TABLE `dictionary_contents` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `dictionary_contents_id_uindex` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=19 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of dictionary_contents
-- ----------------------------
INSERT INTO `dictionary_contents` VALUES ('1', 'job', '职业', '4545454545');
INSERT INTO `dictionary_contents` VALUES ('2', 'source', '来源', '客户来源渠道');
INSERT INTO `dictionary_contents` VALUES ('3', 'intentionDegree', '意向程度', '喜不喜欢呢');
...
INSERT INTO `dictionary_contents` VALUES ('15', 'customerType', '企业客户类型', '直接客户，合作商，渠道商，供应商');
INSERT INTO `dictionary_contents` VALUES ('16', 'ent_coo_type1', '供应商分类', '采购供应商分类');
INSERT INTO `dictionary_contents` VALUES ('17', 'customerType', '公私合营', '直接客户，合作商，渠道商，供应商');
INSERT INTO `dictionary_contents` VALUES ('18', 'cloudtype', '冷冻类型', '仓库冷冻类型');
...
CREATE TABLE `dictionary_details` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY ` dictionary_details_id_uindex` (`id`) USING BTREE
...
INSERT INTO `dictionary_details` VALUES ('30', '电话沟通', '12', '10');
...
INSERT INTO `dictionary_details` VALUES ('50', '直接客户', '1', '15');
INSERT INTO `dictionary_details` VALUES ('51', '集成商', '2', '15');
INSERT INTO `dictionary_details` VALUES ('52', '签约渠道商', '3', '15');
INSERT INTO `dictionary_details` VALUES ('53', '供应商', '4', '15');
INSERT INTO `dictionary_details` VALUES ('54', '供应商', '222', '1');
INSERT INTO `dictionary_details` VALUES ('55', '产品单位', '999', '1');
INSERT INTO `dictionary_details` VALUES ('56', '222', '999', '1');
INSERT INTO `dictionary_details` VALUES ('57', '333', '999', '1');
INSERT INTO `dictionary_details` VALUES ('58', '开发人员', '22', '1');
INSERT INTO `dictionary_details` VALUES ('60', '硬件供应商', '1', '16');
INSERT INTO `dictionary_details` VALUES ('61', '供应商', '1', '17');
INSERT INTO `dictionary_details` VALUES ('62', '1级测试', '1', '9');
INSERT INTO `dictionary_details` VALUES ('63', '2级测试', '3', '9');
INSERT INTO `dictionary_details` VALUES ('64', '3级测试', '2', '9');
INSERT INTO `dictionary_details` VALUES ('65', '-50C冷冻', '1', '18');
INSERT INTO `dictionary_details` VALUES ('66', '低温冷冻', '2', '18');
INSERT INTO `dictionary_details` VALUES ('67', '恒温冷冻', '3', '18');
INSERT INTO `dictionary_details` VALUES ('68', '邮件沟通', '2', '10');

-- ----------------------------
-- Table structure for dictionary_table_biz_ref
-- ----------------------------
DROP TABLE IF EXISTS `dictionary_table_biz_ref`;
CREATE TABLE `dictionary_table_biz_ref` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '字典与业务绑定表',
  `biz_name` varchar(50) NOT NULL COMMENT '业务设置表：1、企业表，2、联系人表，3、员工表、4跟进表、5、业务表、6其他',
  `table_name` varchar(50) DEFAULT NULL COMMENT '数据库表名称',
  `schema_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '主要是字典的名字与id的数组{dic_id:2, dic_name:type}多个数字组成' CHECK (json_valid(`schema_json`)),
  `is_sys` int(11) NOT NULL DEFAULT 0 COMMENT '0 不是系统默认，1是系统默认',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COMMENT='字典跟各个业务表的绑定表';

-- ----------------------------
-- Records of dictionary_table_biz_ref
-- ----------------------------
INSERT INTO `dictionary_table_biz_ref` VALUES ('1', '系统默认', '联系人', , '1');
INSERT INTO `dictionary_table_biz_ref` VALUES ('2', '系统默认', '企业表', , '1');
INSERT INTO `dictionary_table_biz_ref` VALUES ('3', '系统默认', '跟进表', , '1');
INSERT INTO `dictionary_table_biz_ref` VALUES ('4', '系统默认', '产品表', , '1');
INSERT INTO `dictionary_table_biz_ref` VALUES ('5', '系统默认', '项目表', , '1');

-- ----------------------------
-- Table structure for dictionary_table_biz_value
-- ----------------------------
DROP TABLE IF EXISTS `dictionary_table_biz_value`;
CREATE TABLE `dictionary_table_biz_value` (
  `id` int(11) NOT NULL,
  `biz_table_name` varchar(255) DEFAULT NULL COMMENT '业务名称',
  `biz_dic_id` int(11) DEFAULT NULL,
  `biz_dic_title` varchar(255) DEFAULT NULL COMMENT '业务字段名称',
  `biz_dic_value_id` varchar(255) DEFAULT NULL COMMENT '业务字段值',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- ----------------------------
-- Records of dictionary_table_biz_value
-- ----------------------------
...
CREATE TABLE `employee` (
  ...
  `state` int(11) NOT NULL DEFAULT 1 COMMENT '状态 1正常 0离职',
  `admin` int(11) NOT NULL DEFAULT 0 COMMENT '超级管理员身份 1超管 0普通',
  `login_time` datetime DEFAULT NULL,
  `register_time` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `employee_id_uindex` (`id`) USING BTREE,
  UNIQUE KEY `employee_name_uindex` (`name`) USING BTREE,
  UNIQUE KEY `employee_email_uindex` (`email`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1094 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- ----------------------------
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('1', 'admin', '$2a$10$OG1zaFHT2LUy4SGcQ4EnRu9sPQMjMGEE6jARz61aQwRQ3316N6ikG', '1623@163.com', '20', '2', '2021-05-14 00:28:00', '1', '1', '2023-09-08 17:29:30', '2021-05-21 08:46:19');
...
CREATE TABLE `employee_role` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `employee_role_id_uindex` (`id`) USING BTREE
...
CREATE TABLE `json_test` (
  ...
  `project` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT '' CHECK (json_valid(`project`)),
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `json_test` VALUES ('1', 0x5B7B226964223A2031303030312C20226E616D65223A2022E7AEA1E79086E59198227D2C207B226964223A2031303030322C20226E616D65223A2022E5BC80E58F91227D2C207B226964223A2031303030332C20226E616D65223A2022E6B58BE8AF95227D5D, 0x7B226964223A2031313131312C20226E616D65223A2022E9A1B9E79BAE31227D);
INSERT INTO `json_test` VALUES ('2', 0x5B7B226964223A2031303030322C20226E616D65223A2022E5BC80E58F91227D5D, 0x7B226964223A2032323232322C20226E616D65223A2022E9A1B9E79BAE32227D);
INSERT INTO `json_test` VALUES ('3', 0x5B7B226964223A2031303030312C20226E616D65223A2022E7AEA1E79086E59198227D2C207B226964223A2031303030322C20226E616D65223A2022E5BC80E58F91227D2C207B226964223A2031303030332C20226E616D65223A2022E6B58BE8AF95227D5D, 0x7B226964223A2031313131312C20226E616D65223A2022E9A1B9E79BAE31227D);
...
CREATE TABLE `permission` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `permission_id_uindex` (`id`) USING BTREE
...
CREATE TABLE `products` (
  ...
  `product_unit` varchar(5) NOT NULL COMMENT '产品的单位',
  `product_unit_price` decimal(10,2) DEFAULT NULL COMMENT '产品单价',
  `product_desc` varchar(255) DEFAULT NULL COMMENT '产品描述（简述）',
  `product_img` varchar(255) DEFAULT NULL COMMENT '产品图片',
  `product_status` int(11) DEFAULT NULL COMMENT '产品状态，正常，锁定，过期，',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `products` VALUES ('2', '隔离网交换KWS', '并发', '50000.00', '隔离网交换', null, null, '2023-08-07 19:45:43', null);
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='角色表';
...
CREATE TABLE `role_permission` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE KEY `role_permission_id_uindex` (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=426 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='角色权限中间表';
...
CREATE TABLE `welcome` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `wise` varchar(255) DEFAULT NULL COMMENT '名人名言',
  `frequency` int(10) unsigned zerofill DEFAULT NULL COMMENT '展示频率',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=711 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
