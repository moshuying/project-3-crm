...
CREATE TABLE `baobei`  (
  `id` int NOT NULL,
  `biz_id` int NULL DEFAULT NULL,
  `cent_id` int NOT NULL COMMENT '渠道企业id',
  `cent_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '渠道企业名称',
  `protected_period` date NULL DEFAULT NULL COMMENT '保护到期时间，每次延长3个月',
  `cuser_id` int NULL DEFAULT NULL COMMENT '渠道销售id',
  ...
  `create_user_id` int NOT NULL COMMENT '报备人',
  `success` enum('ok','no','wait','forbid') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT 'ok' COMMENT '报备状态',
...
CREATE TABLE `bizs`  (
  ...
  `biz_type` enum('niche','index') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'niche' COMMENT '商机、线索',
  `biz_resources` enum('baobei','website','activity','other') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT 'website' COMMENT '来源（渠道、官网、活动、其他）',
  ...
  `products` json NULL COMMENT '产品{id:name,id:name}',
  `biz_count` int NULL DEFAULT NULL COMMENT '预计成交金额',
  `biz_okday` date NULL DEFAULT NULL COMMENT '预计成交时间',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '商机管理表，管理商机报备，内外报备，提醒跟进等' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of bizs
-- ----------------------------
INSERT INTO `bizs` VALUES (1, 'niche', 'website', '中国的公司', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-10-10 20:17:24', NULL);
INSERT INTO `bizs` VALUES (2, 'niche', 'website', '中国的公司', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-10-10 20:19:33', NULL);
INSERT INTO `bizs` VALUES (3, 'niche', 'website', '中国的公司', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-10-10 20:21:50', NULL);
...
CREATE TABLE `customer_enterprise`  (
  ...
  `ent_sn` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '企业统一信用代码',
  `ent_boss` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '企业法人',
  `ent_addr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '企业地址',
  `ent_tel` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '企业电话',
  `ent_email` varchar(60) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '企业邮箱',
  `ent_website` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '企业官网',
  `ent_desc` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT '' COMMENT '企业简单描述，来自爱企查',
  `ent_cooperation_type` int NULL DEFAULT NULL COMMENT '企业与厂家合同类型：1、直接客户、2、渠道代理、3、供应商、4、战略合作、5、其他合作形式',
  `ent_belong_bizer_id` int NULL DEFAULT NULL COMMENT '该企业属于哪个销售人员负责',
  `ent_belong_bizer_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '营销人员姓名',
  ...
  UNIQUE INDEX `unique`(`ent_name`) USING BTREE COMMENT '企业名称要唯一',
  INDEX `epid`(`ent_belong_bizer_id`) USING BTREE,
  CONSTRAINT `epid` FOREIGN KEY (`ent_belong_bizer_id`) REFERENCES `employee` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
CREATE TABLE `customer_manager`  (
  ...
  `status` int NOT NULL DEFAULT 0 COMMENT '-2:流失 -1:开发失败 0:潜在客户 1:正式客户 2:资源池客户',
  `positiveTime` datetime(0) NULL DEFAULT NULL COMMENT '转正时间',
  `customer_ent_id` int NULL DEFAULT NULL COMMENT '企业id',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `customer_manager_id_uindex`(`id`) USING BTREE
...
CREATE TABLE `dictionary_table_biz_ref`  (
  `id` int NOT NULL AUTO_INCREMENT COMMENT '字典与业务绑定表',
  `biz_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '业务设置表：1、企业表，2、联系人表，3、员工表、4跟进表、5、业务表、6其他',
  `table_name` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '数据库表名称',
  `schema_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '主要是字典的名字与id的数组{dic_id:2, dic_name:type}多个数字组成',
  `is_sys` int NOT NULL DEFAULT 0 COMMENT '0 不是系统默认，1是系统默认',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '字典跟各个业务表的绑定表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of dictionary_table_biz_ref
-- ----------------------------
INSERT INTO `dictionary_table_biz_ref` VALUES (1, '系统默认', '联系人', '[{\"id\":1,\"sn\":\"工作\",\"title\":\"jon\",\"intro\":\"sadfasdf\"},{\"id\":1,\"sn\":\"工作\",\"title\":\"jon\",\"intro\":\"sadfasdf\"},{\"id\":8,\"sn\":\"Foreign language proficiency\",\"title\":\"外语水平\",\"intro\":\"Foreign language proficiency\"}]', 1);
INSERT INTO `dictionary_table_biz_ref` VALUES (2, '系统默认', '企业表', '[{\"id\":8,\"sn\":\"Foreign language proficiency\",\"title\":\"外语水平\",\"intro\":\"Foreign language proficiency\"},{\"id\":6,\"sn\":\"School nature\",\"title\":\"办学性质\",\"intro\":\"School nature\"},{\"id\":17,\"sn\":\"customerType\",\"title\":\"公私合营\",\"intro\":\"直接客户，合作商，渠道商，供应商\"},{\"id\":3,\"sn\":\"intentionDegree\",\"title\":\"意向程度\",\"intro\":\"喜不喜欢呢\"}]', 1);
INSERT INTO `dictionary_table_biz_ref` VALUES (3, '系统默认', '跟进表', '[{\"id\":1,\"sn\":\"工作\",\"title\":\"jon\",\"intro\":\"sadfasdf\"},{\"id\":8,\"sn\":\"Foreign language proficiency\",\"title\":\"外语水平\",\"intro\":\"Foreign language proficiency\"},{\"id\":10,\"sn\":\"Follow-up method\",\"title\":\"跟进方式\",\"intro\":\"客户跟进的方式\"}]', 1);
INSERT INTO `dictionary_table_biz_ref` VALUES (4, '系统默认', '产品表', '[{\"id\":1,\"sn\":\"工作\",\"title\":\"jon\",\"intro\":\"sadfasdf\"},{\"id\":3,\"sn\":\"intentionDegree\",\"title\":\"意向程度\",\"intro\":\"喜不喜欢呢\"},{\"id\":8,\"sn\":\"Foreign language proficiency\",\"title\":\"外语水平\",\"intro\":\"Foreign language proficiency\"}]', 1);
INSERT INTO `dictionary_table_biz_ref` VALUES (5, '系统默认', '项目表', '[{\"id\":3,\"sn\":\"intentionDegree\",\"title\":\"意向程度\",\"intro\":\"喜不喜欢呢\"},{\"id\":2,\"sn\":\"source\",\"title\":\"来源\",\"intro\":\"客户来源渠道\"},{\"id\":8,\"sn\":\"Foreign language proficiency\",\"title\":\"外语水平\",\"intro\":\"Foreign language proficiency\"},{\"id\":18,\"sn\":\"cloudtype\",\"title\":\"冷冻类型\",\"intro\":\"仓库冷冻类型\"}]', 1);
...
CREATE TABLE `dictionary_table_biz_value`  (
  `id` int NOT NULL,
  `biz_table_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '业务名称',
  `biz_dic_id` int NULL DEFAULT NULL,
  `biz_dic_title` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '业务字段名称',
  `biz_dic_value_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '业务字段值',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES (1, 'admin', '$2a$10$OG1zaFHT2LUy4SGcQ4EnRu9sPQMjMGEE6jARz61aQwRQ3316N6ikG', '1623@163.com', 20, 2, '2021-05-14 00:28:00', 1, 1, '2023-11-04 13:32:20', '2021-05-21 08:46:19');
...
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色表' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 425 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '角色权限中间表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `welcome`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 710 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
