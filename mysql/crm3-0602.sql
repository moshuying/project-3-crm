...
CREATE TABLE `dictionary_table_biz_ref` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COMMENT='字典跟各个业务表的绑定表';

-- ----------------------------
-- Records of dictionary_table_biz_ref
-- ----------------------------
INSERT INTO `dictionary_table_biz_ref` VALUES ('1', '业务配置', '企业表', 0x7B226469634964223A312C226E616D65223A22E5B7A5E4BD9C227D);
...
-- Records of employee
-- ----------------------------
INSERT INTO `employee` VALUES ('1', 'admin', '$2a$10$OG1zaFHT2LUy4SGcQ4EnRu9sPQMjMGEE6jARz61aQwRQ3316N6ikG', '1623@163.com', '20', '2', '2021-05-14 00:28:00', '1', '1', '2023-06-02 10:26:06', '2021-05-21 08:46:19');
